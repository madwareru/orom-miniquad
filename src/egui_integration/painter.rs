...
impl Painter {
    pub fn new(ctx: &mut Context) -> Painter {
        ...
        let bindings = Bindings {
            ...
            index_buffer,
            images: vec![crate::Texture::empty()],
        };
        ...
        Painter {
            ...
            egui_texture: crate::Texture::empty(),
        }
    }
    ...
    fn rebuild_egui_texture(&mut self, ctx: &mut Context, texture: &egui::Texture) {
        ...
        self.egui_texture = crate::Texture::from_data_and_format(
            ctx,
            &texture_data,
            crate::TextureParams {
                format: crate::TextureFormat::RGBA8,
                wrap: crate::TextureWrap::Clamp,
    ...
    pub fn paint(
        ...
        ctx.begin_default_pass(crate::PassAction::Nothing);
    ...
    pub fn paint_job(&mut self, ctx: &mut Context, clip_rect: egui::Rect, mesh: egui::paint::Mesh) {
        ...
        // TODO: support u32 indices in crate and just use "mesh.indices" without a need for `split_to_u16`
        ...
        for mesh in meshes {
            ...
            self.bindings.images[0] = match mesh.texture_id {
                ...
                egui::TextureId::User(id) => unsafe { crate::Texture::from_raw_id(id as u32) },
            };
...
mod shader {
    use crate::{ShaderMeta, UniformBlockLayout, UniformDesc, UniformType};
    ...
    void main() {
        ...
        // crate doesn't support linear blending in the framebuffer.
